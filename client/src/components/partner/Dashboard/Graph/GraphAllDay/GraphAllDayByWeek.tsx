...
function GraphAllDayByWeek() {
  ...
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-per-week`,
    fetcher
  );
  ...
  const labels = [];
  const datas = [];
  dataSets = sortLabelsWeek.filter((label:Resualt) => {
    let found = false;
...
export default GraphAllDayByWeek;
