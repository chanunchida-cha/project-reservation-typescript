...
import GraphAllDayByDay from "./Graph/GraphAllDay/GraphAllDayByDay";
import GraphAllDayByWeek from "./Graph/GraphAllDay/GraphAllDayByWeek";
import GraphAllDayByMonth from "./Graph/GraphAllDay/GraphAllDayByMonth";
import GraphAllDayByYear from "./Graph/GraphAllDay/GraphAllDayByYear";
...
function useDashboardAlldatyData() {
  ...
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-today`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv`,
    fetcher
  );
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-last-week`,
    fetcher
  );
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-next-week`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-pending`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-arrived`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-check-out`,
    fetcher
  );
  const {
    data: cancel,
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-cancel`,
    fetcher
  );
