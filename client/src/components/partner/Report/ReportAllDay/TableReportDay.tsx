...
function TableReportDay() {
  ...
  const {
    ...
    `${process.env.REACT_APP_API_REPORT}/partner/get-count-allday-reserv-per-day`,
  ...
  const sortLabelsDay = countReservPerDay
    .slice()
  ...
  const pageCount = Math.ceil(countReservPerDay.length / dataPerPage);
