...
const EditPartner = observer(() => {
  ...
  useEffect(() => {
    const getAdminById = async () => {
      ...
      setInfo({
        firstname: rudStore.partner.firstname,
        lastname: rudStore.partner.lastname,
        email: rudStore.partner.email,
        phoneNumber: rudStore.partner.phoneNumber,
        restaurantName: rudStore.partner.restaurantName,
        address: rudStore.partner.address,
        username: rudStore.partner.username,
        password: rudStore.partner.password,
        confirmPass: rudStore.partner.confirmPass,
      });
    };
    getAdminById();
  }, []);

  async function editPartnerSubmit(e: FormEvent<HTMLFormElement>) {
    e.preventDefault();
    await rudStore.editPartnerByAdmin(id!, info);
  }
