...
const EditAdmin = observer(() => {
  ...
  useEffect(() => {
    const getAdminById = async () => {
      await rudStore.getAdminByID(id!);
      setInfo({
        firstname: rudStore.admin.firstname,
        lastname: rudStore.admin.lastname,
        email: rudStore.admin.email,
        phoneNumber: rudStore.admin.phoneNumber,
        username: rudStore.admin.username,
        password: rudStore.admin.password,
        confirmPass: rudStore.admin.confirmPass,
      });
    };
    getAdminById();
  }, []);
  ...
  async function editAdminSubmit(e: FormEvent<HTMLFormElement>) {
    e.preventDefault();
    await rudStore.editAdminByAdmin(id!, info);
  }
