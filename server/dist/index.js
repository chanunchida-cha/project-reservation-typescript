...
const historyReservRoute_1 = __importDefault(require("./routes/historyReservRoute"));
const customerRoute_1 = __importDefault(require("./routes/customerRoute"));
const adminRoute_1 = __importDefault(require("./routes/adminRoute"));
const reportPartnerRoute_1 = __importDefault(require("./routes/reportPartnerRoute"));
const reportAdminRoute_1 = __importDefault(require("./routes/reportAdminRoute"));
...
app.use("/history", historyReservRoute_1.default);
app.use("/report", reportPartnerRoute_1.default);
app.use("/report", reportAdminRoute_1.default);
